...
public class CodeTest2_Solution {
    /**
     * Ques-2:
     ...
     *
     */
    public Set<String> printCommonInArrays(String[] array1, String[] array2) {
        ...
        for (String fromArray1 : array1) {
            for (String fromArray2 : array2) {
                if (fromArray1.equalsIgnoreCase(fromArray2)) {
                    commonValues.add(fromArray1.toLowerCase());
                }
            }
        }
        return commonValues;
     ...
     *
     */
    public static int smallestPositiveNum(int [] inputArray) {
        int smallPositiveNum;
